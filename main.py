...
if __name__ == '__main__':
    ...
    try:
        last_xkcd_comics = XKCDComics(**last_comics_response_json)
    ...
    try:
        xkcd_comics = XKCDComics(**comics_response_json)
    except XKCDComicsException as e:
        sys.exit(f'An error has occurred object initialization {e}.')
    ...
    vk_poster.get_image_url_upload().upload_image().save_image().post_image_on_wall()
